...
public class GriddingTestMocks {
    ...
    public List<String> getBookingReportHeaders() {
        logger.trace("Getting Mocked Booking Report Headers.");
        ...
        return List.of(
                ...
                "Race Waiver",
                "I accept race waiver",
                "Cycling Ireland Licence Number",
                "CI Club",
                "Rider Category",
                "UCI ID",
                "Nationality",
                "Team",
                "I agree to be contacted by Eventmaster",
                "I agree to be contacted by this organiser",
                "CI Licence Number",
                "CI Club",
                "CI mid",
                "CI Rider Category",
                ...
                "Additional Purchases Details",
                "Additional Purchases Options",
                "Additional Purchases Variants",
                "Additional Purchases Total Paid"
        );
    }

    public ValueRange getBookingReport2Values() {

        logger.trace("Getting Mocked Booking Report Values.");
